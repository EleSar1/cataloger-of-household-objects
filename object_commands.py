...
def handle_object_addition(choice: int, filename: str, data: dict):

    if not isinstance(choice, int):
        raise TypeError("Expected an integer for 'choice' parameter, got a different type.")
...
def handle_object_modification(choice: int, filename: str, data: dict):
...
def handle_object_deletion(choice: int, filename: str, data: dict):
